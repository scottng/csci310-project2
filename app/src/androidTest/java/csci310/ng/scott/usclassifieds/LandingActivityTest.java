    ...
    public void landingActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.edit_text_full_name),
                        childAtPosition(
                                allOf(withId(R.id.layout_create_account_form),
                                        childAtPosition(
                                                withClassName(is("androidx.constraintlayout.widget.ConstraintLayout")),
                                                1)),
                                2),
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.edit_text_full_name),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("Yolanda"), closeSoftKeyboard());

        ViewInteraction editText = onView(
                allOf(withId(R.id.edit_text_full_name), withText("Yolanda"),
                        childAtPosition(
                                allOf(withId(R.id.layout_create_account_form),
                                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        editText.check(matches(withText("Yolanda")));
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.edit_text_email),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("yolanda@usc.edu"), closeSoftKeyboard());

        ViewInteraction editText2 = onView(
                allOf(withId(R.id.edit_text_email), withText("yolanda@usc.edu"),
                        childAtPosition(
                                allOf(withId(R.id.layout_create_account_form),
                                        childAtPosition(
                                                IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class),
                                ...
                                3),
                        isDisplayed()));
        editText2.check(matches(withText("yolanda@usc.edu")));
        ...
        ViewInteraction editText3 = onView(
                allOf(withId(R.id.edit_text_password), withText("••••••••"),
                        childAtPosition(
                                allOf(withId(R.id.layout_create_account_form),
                                        childAtPosition(
                                                IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class),
